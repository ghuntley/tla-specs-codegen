...
\* BEGIN TRANSLATION (chksum(pcal) = "b44ff6dd" /\ chksum(tla) = "8a55f8c2")
...
Main == /\ pc[0] = "Main"
        /\ IF i <= NumRoutines
              ...
              ELSE /\ pc' = [pc EXCEPT ![0] = "Get"]
                   /\ UNCHANGED << channels, initialized, i >>
